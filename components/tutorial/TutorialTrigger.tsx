...
export function TutorialTrigger({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded border border-primary/30 bg-primary/5 px-4 py-2 text-sm font-medium text-primary shadow-sm transition-colors hover:border-primary hover:bg-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${className}`}
    >
