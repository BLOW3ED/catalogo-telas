    ...
    >
      ...
      <div className="flex h-9 items-center justify-between border-b border-line/60 bg-surface-container-low/70 px-3.5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-[11px] font-bold tracking-tight text-ink-display">
  ...
  return (
    <div className="flex flex-col gap-1.5 rounded-xl border border-line/60 bg-surface-container-lowest p-2 shadow-2xs transition-transform">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <p className="font-display text-[11px] font-bold leading-tight text-ink-display truncate">
          {nombre}
        </p>
        <p className="text-[11px] font-bold leading-none text-amber mt-0.5">
          {precio}
        </p>
      </div>
    </div>
  ...
  return (
    <Marco>
      ...
      <div className="mt-3 grid grid-cols-3 gap-2">
        <MiniCard
          retazo="from-[#C9AB8C] via-[#AE7C5F] to-[#7D5438]"
          nombre="Lino Crudo"
          categoria="Lino"
          precio="$180 / m"
        />
        <MiniCard
          retazo="from-[#1D2A40] via-[#0F1D2E] to-[#060C14]"
          nombre="Chifón Noche"
          categoria="Fiesta"
          precio="$120 / m"
        />
...
export function MaquetaColor() {
  const colores = [
    { hex: "#6E4B7A", nombre: "Ciruela" },
    { hex: "#AE7C5F", nombre: "Terracota", activo: true },
    ...
    <Marco>
      <div className="flex gap-3 items-center">
        ...
        <div className="w-[42%] shrink-0">
          <Retazo
            className="from-[#C9AB8C] via-[#AE7C5F] to-[#7D5438]"
            label="Terracota"
          />
        </div>
        ...
        <div className="flex flex-1 flex-col justify-center gap-1.5">
          <div>
            ...
            <p className="font-display text-sm font-bold leading-tight text-ink-display">
              Lino Italiano
            </p>
            <p className="text-xs font-bold text-amber">$180 / metro</p>
          </div>
    ...
    <Marco>
      <div className="flex gap-3 items-center">
        ...
        <div className="flex flex-1 flex-col justify-center gap-2">
          <div>
            <p className="font-display text-xs font-bold leading-tight text-ink-display">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center justify-between rounded-xl border border-line/60 bg-surface-container px-2 py-1 shadow-inner-xs">
                ...
                <div className="text-center">
                  <span className="text-xs font-bold text-ink-display">3.5</span>
                  <span className="ml-1 text-[9px] font-bold uppercase text-amber">
                    metros
                  </span>
                </div>
                <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-surface-container-lowest text-xs font-bold text-ink-display shadow-2xs">
