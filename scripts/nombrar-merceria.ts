...
const FICHAS: Record<string, Ficha> = {
  ...
  bnk1070: { nombre: "Tira fina de piedra con racimo", color: "Cristal AB" },
  ...
  bnk621: { nombre: "Tira de espiga de navette", color: "Cristal AB" },
  ...
  kp1601: { nombre: "Tira de un hilo de piedra chica", color: "Cristal AB" },
  ...
  tdc68: { nombre: "Tira de dos hileras con piedra AB", color: "Cristal AB" },
...
const SOLO_COLOR: Record<string, string> = {
  ...
  "piedra-b1403-12-pz-a": "Cristal AB",
